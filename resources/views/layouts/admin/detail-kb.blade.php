    ...
    <div class="row col-md-12 col-12 ms-0 mt-2">
        ...
        <div class="col-md-12 ms-0">
            <div class="overflow-x-scroll">
                <table id="tabel-data" class="table table-responsive table-sm border-black border-2 table-bordered">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="mb-3 form-outline border-0 border-bottom border-dark" id="result">
                                        ...
                                        <input type="number" class="form-control" id="umurIbu" aria-describedby=""
                                            value="{{ $kb->Suami->nik }}">
                                        {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                                    </div>
                                    <div class="mb-3 form-outline border-0 border-bottom border-dark">
                                        ...
                                        <input type="number" class="form-control" id="jumlah-anak" aria-describedby=""
                                            name="jmlh_anak" value="{{ $kb->jmlh_anak }}">
                                        {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                                    </div>
                                </div>
                                {{-- tengah --}}
                                <div class="col-md-3">
                                    ...
                                    <div class="mb-3 form-outline border-0 border-bottom border-dark ">
                                        ...
                                        <input type="text" class="form-control" id="pasca-salin" aria-describedby=""
                                            name="pasca_salin" value="{{ $kb->pasca_salin }}">
                                        {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                                    </div>
                                    <div class="mb-3 form-outline border-0 border-bottom border-dark">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="mb-3 form-outline border-0 border-bottom border-dark">
                                        ...
                                        <input type="number" class="form-control" id="beratBadan" aria-describedby=""
                                            name="berat_badan" value="{{ $kb->berat_badan }}">
                                        {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                                    </div>
                                    <div class="mb-3 form-outline border-0 border-bottom border-dark">
                                        ...
                                        <input type="number" class="form-control" id="tinggiBadan" aria-describedby=""
                                            name="tinggi_badan" value="{{ $kb->tinggi_badan }}">
                                        {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                                    </div>
                                    <div class="mb-3 form-outline border-0 border-bottom border-dark">
                                        <label for="tensi" class="form-label">Tensi</label>
                                        <input type="number" class="form-control" id="tensi" aria-describedby=""
                                            name="tensi" value="{{ $kb->tensi }}">
                                        {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                                    </div>
                                    <div class="mb-3 form-outline border-0 border-bottom border-dark">
                                        <label for="lila" class="form-label">Lila</label>
                                        <input type="number" class="form-control" id="lila" aria-describedby=""
                                            name="lila" value="{{ $kb->lila }}">
                                        {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                                    </div>
                                </div>
                                {{-- kanan --}}
